...
import { 
  ...
  FolderCheck, BookOpen, Stethoscope 
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans flex flex-col justify-between">
      ...
      <main className="flex-grow max-w-4xl w-full mx-auto px-4 py-8 sm:py-12 space-y-8">
          ...
          <div className="overflow-x-auto border border-slate-200/80 rounded-2xl">
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-slate-100 font-medium text-slate-700">
                ...
                <tr className="bg-slate-900 text-white font-bold"><td className="py-2.5 px-4 text-center">12</td><td className="py-2.5 px-4">Pengumuman Hasil Akhir</td><td className="py-2.5 px-4 text-right text-teal-400">12 Agustus 2026</td></tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="rounded-3xl border border-teal-200 bg-teal-50/80 p-5 shadow-sm">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h3 className="text-sm font-extrabold uppercase tracking-wide text-teal-900">Pengumuman Resmi Seleksi</h3>
              <p className="mt-1 text-xs text-teal-700">Klik tombol berikut untuk mengunduh dokumen pengumuman resmi dari Google Drive.</p>
            </div>
            <a
